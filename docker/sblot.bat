...
if "%~1"=="" (
  echo Usage: run_sbayes.bat path\to\config.json [additional sBlot CLI arguments...]
  exit /b 1
)
...
:run
docker run --rm -v "%CONFIG_DIR%:/data" sbayes python -m sblot /data/%CONFIG_FILE% %CLI_ARGS%
