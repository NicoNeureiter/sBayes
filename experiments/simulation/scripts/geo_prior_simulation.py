...
TEST_SAMPLING_DIRECTORY = 'results/prior/geo_prior/{experiment}/'.format(experiment=experiment_name)
TEST_SAMPLING_RESULTS_PATH = TEST_SAMPLING_DIRECTORY + 'geo_prior_pg{pg}_{run}.pkl'
...
P_N_CATEGORIES_SIM = {'2': 0.2, '3': 0.4, '4': 0.4}
...
if __name__ == '__main__':
    ...
    for i in PRIOR_TEST:
        ...
        if i:
            ...
            PRIOR = {'geo': {'type': "distance", 'parameters': {}},
        ...
        PRIOR['geo']['parameters']['magnification_factor'] = 15.
        ...
        for run in range(N_RUNS):
            ...
            # Zone with index 0 is the relevant (spatially compact), which we want to find when the prior is on

            zones_sim_compact = zones_sim[np.newaxis, 1, :]
            ...
            run_stats['true_zones'] = zones_sim_compact
