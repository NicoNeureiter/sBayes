...
if __name__ == '__main__':
    results_per_model = {}
    models = GeneralPlot()
    models.load_config(config_file='../results/full_prior/config_plot.json')
    ...
    for m in names:
        ...
        for mpf in min_posterior_frequency:
            ...
            map = Map()
            map.load_config(config_file='../results/full_prior/config_plot.json')
        ...
        plt = GeneralPlot()
        plt.load_config(config_file='../results/full_prior/config_plot.json')
