...
# File location
TEST_SAMPLING_DIRECTORY = 'results/shared_evolution/prior_p_global/{experiment}/'.format(experiment=experiment_name)
TEST_SAMPLING_RESULTS_PATH = TEST_SAMPLING_DIRECTORY + 'bk_prior_p_global_nz{nz}_{run}.pkl'
