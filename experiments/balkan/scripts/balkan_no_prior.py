...
# File location
TEST_SAMPLING_DIRECTORY = 'results/shared_evolution/no_prior/{experiment}/'.format(experiment=experiment_name)
TEST_SAMPLING_RESULTS_PATH = TEST_SAMPLING_DIRECTORY + 'bk_no_prior_nz{nz}_{run}.pkl'
