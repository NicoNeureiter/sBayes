if __name__ == '__main__':
    ...
    for n_zone in n_zones:
        ...
        sample_path = f'{PATH_BK}{TEST_ZONE_DIRECTORY}bk_no_prior_nz{n_zone}_{run}.pkl'
    ...
    while True:
        try:
            # Load the MCMC results
            sample_path = f'{PATH_BK}{TEST_ZONE_DIRECTORY}bk_no_prior_nz{n_zone_file}_{run}.pkl'
