...
class ZoneMCMC(MCMCGenerative):
    ...
    def parse_operator_weights(self, op_weights_raw):
        ...
        GIBBSISH_ZONE_STEPS = False
        if GIBBSISH_ZONE_STEPS:
            op_weights = {
                'shrink_zone': op_weights_raw['area'] * 0.04,
                'grow_zone': op_weights_raw['area'] * 0.04,
                'swap_zone': op_weights_raw['area'] * 0.02,
                'gibbsish_sample_zones': op_weights_raw['area'] * 0.9
            }
        else:
            op_weights = {
